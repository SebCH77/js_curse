...
// const arr = [1, 2];
// rest.set(arr, 'Test');
/* console.log(rest.get([1, 2])); */ //NO SE PUEDE! NO EL MISMO OBJETO ([1, 2]);
//PARA QUE SI FUNCIONE:
/* console.log(rest.get(arr)); */ //Aquí si hacen referencia al mismo lugar en memoria.
...
//   passengerLower[0].toUpperCase() + passengerLower.slice(1); //OJO!!!!!!!!!!1
