...
// Checking if value is number //OJO!!!
...
///////////////////////////////////////
/*
// Working with BigInt //Para almacenar números tan grandes como queramos.
console.log(2 ** 53 - 1);
...
const days1 = calcDaysPassed(new Date(2037, 3, 4), new Date(2037, 3, 14)); //El resultado es en miliseconds, se convierte!!!
console.log(days1);
*/
